...
export function brand() {
  ...
  <section class="brand-guidance sd-card" aria-labelledby="brand-name"><span class="section-index">Name &amp; capitalization</span><h2 id="brand-name">Write it Slang.</h2><p><strong>Slang</strong> is the canonical name of the language and product in prose, headings, interface text, and accessible names.</p><ul><li>Use <strong>Slang Design</strong>, <strong>Slang Editor</strong>, <strong>Slang Run</strong>, and “Built with Slang.”</li><li>Keep the approved logo’s lowercase <strong>slang</strong> wordmark. Its accessible name is still “Slang.”</li><li>Preserve exact technical identifiers: <code>slang</code>, <code>slangd</code>, <code>@bitspark/slang-design</code>, <code>slang.run</code>, and <code>SLANG_DIR</code>.</li><li>Avoid <strong>SLANG</strong> as an alternative brand name; do not treat it as an acronym. All-capital labels are presentation styling applied to source text written as “Slang.”</li></ul><a class="text-link" href="https://github.com/Bitspark/slang-design/blob/main/docs/logo.md#name-and-capitalization">Read the naming convention ${icon('arrow')}</a></section>
